...
class Procedimiento:
    ...
    def __init__(self):
        ...
        self.s_file = '/Users/magaliboulanger/Documents/Dataset/text.npz'
        self.i_file = '/Users/magaliboulanger/Documents/Dataset/img.npz'
    ...
    def proceder(self):
        ...
        if not os.path.exists(self.i_file):
            ...
            model.to(device)
            train_img = self.encode_images(model, self.train, preprocess, device)
            ...
            dev_img = self.encode_images(model, self.dev, preprocess, device)
        ...
        # clustering
        cluster = BisectingKMeans(16, random_state=42)
        ...
        return classification_report(y_test, y_pred > 0.01, output_dict=True)
